...
const SignUp = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Handle structural error returns if present on the payload object
      if (response?.error) {
      ...
      // Catch blocks handle threw exceptions safely
  ...
  const handleClerkError = (error: any) => {
    ...
    // Extract the clean string from Clerk's unique error array structure
